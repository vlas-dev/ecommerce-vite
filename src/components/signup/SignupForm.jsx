...
export default function SignUp() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex justify-center items-center">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-lg mt-20 md:mt-0 mx-20">
        <h2 className="text-2xl font-bold mb-4 text-center">Registrarse</h2>
        <form onSubmit={crearUsuario} className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            <label htmlFor="firstName" className="block text-gray-700 text-sm font-bold mb-2 sr-only">
              Nombre
            </label>
          ...
          <div className="col-span-2">
            <label htmlFor="lastName"  className="block text-gray-700 text-sm font-bold mb-2 sr-only">
              Apellido
            </label>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <input type="password" id="password" name="password" value={formState.password} onChange={onInputChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="Contraseña" />
          </div>
          <div className="col-span-2 md:col-span-1">
            <label htmlFor="confirmPassword" className="block text-gray-700 text-sm font-bold mb-2 sr-only">
              Confirmar Contraseña
            </label>
            <input type="password" id="confirmPassword" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" placeholder="Confirmar Contraseña" />
          </div>
